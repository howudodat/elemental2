 ...
 */
webCrypto.Algorithm = function() {};
/**
 * @type {string}
 */
webCrypto.Algorithm.prototype.name;
 ...
 */
webCrypto.AlgorithmIdentifier = function () {};

/**
 * @record
 * @extends webCrypto.AlgorithmIdentifier
 * @see http://www.w3.org/TR/WebCryptoAPI/#dfn-HashAlgorithmIdentifier
 */
webCrypto.HashAlgorithmIdentifier = function () {};
...
webCrypto.KeyAlgorithm = function(){};
/**
 * @type {string}
 */
webCrypto.KeyAlgorithm.prototype.name;
 ...
 * @param {!CryptoKey} key Key to be used for signing.
 ...
 * @param {!CryptoKey} key Private key to be used for signing.
 ...
 *     unwrapKey.
 * @return {!Promise<!CryptoKey|!CryptoKeyPair>} returns the
 *     generated key.
 */
 ...
 * @param {!CryptoKey} baseKey Key to be used by the key
 ...
 *     encrypt, decrypt, sign, verify, deriveKey, deriveBits, wrapKey,
 *     unwrapKey.
 * @return {!Promise<!CryptoKey>} returns the generated key.
 */
 ...
 * @param {!CryptoKey} key CryptoKey to wrap.
 * @param {!CryptoKey} wrappingKey CryptoKey used to perform
 *     the wrapping.
 ...
 *     format.
 * @param {!CryptoKey} unwrappingKey CryptoKey used to perform
 *     the unwrapping.
 ...
 * @param {!Array<string>} keyUsages Indicates what can be done with the
 *     derivated key.
 * @return {!Promise<!CryptoKey>} returns the unwrapped key.
 */
 ...
 * @param {!Int8Array|!Uint8Array|!Uint8ClampedArray|!Int16Array|!Uint16Array|!Int32Array|!Uint32Array}
 *     typedArray
 * @return {!Int8Array|!Uint8Array|!Uint8ClampedArray|!Int16Array|!Uint16Array|!Int32Array|!Uint32Array}
 * @throws {Error}
 */
